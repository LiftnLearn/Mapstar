...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onConnectionFailed(ConnectionResult res) {
        System.out.println("Connection to Google Places failed.");
    }
...
//                // Add a marker at current and move the camera
////                LatLng locationLatLng = new LatLng(location.getLatitude(), location.getLongitude());
////
////
////                MarkerOptions markerOptions = (new MarkerOptions().position(locationLatLng).title("Marker at current location"));
...
//
//            @Override
//            public void onProviderEnabled(String provider) { //TODO: IMPLEMENT }
//
//            @Override
...
//        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0, locationListener);
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://io.mapstar.mapstar/http/host/path")
        );
